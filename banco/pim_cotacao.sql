...
CREATE TABLE `cotacao` (
  ...
  `id_parceiro_negocio` int(11) DEFAULT NULL,
  `valor` double DEFAULT NULL,
  `data_cotacao` date DEFAULT NULL,
  `data_entrega` date DEFAULT NULL,
  PRIMARY KEY (`id_cotacao`),
  KEY `id_produto` (`id_produto`),
  KEY `id_parceiro_negocio` (`id_parceiro_negocio`),
  CONSTRAINT `cotacao_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`),
  CONSTRAINT `cotacao_ibfk_2` FOREIGN KEY (`id_parceiro_negocio`) REFERENCES `parceiro_negocio` (`id_pn`)
