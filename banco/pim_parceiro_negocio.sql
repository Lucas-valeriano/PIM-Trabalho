...
--
-- Table structure for table `parceiro_negocio`
--
...
CREATE TABLE `parceiro_negocio` (
  ...
  `razao_social` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `cnpj` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `parceiro_negocio`
--

LOCK TABLES `parceiro_negocio` WRITE;
/*!40000 ALTER TABLE `parceiro_negocio` DISABLE KEYS */;
INSERT INTO `parceiro_negocio` VALUES (9,'Santiago & Cintra','140514540001-98','Tapajos',2827,'Ipiranga','14060590','NP','RP','SP','Brasil','sac@santiagoecintra.com.br','2018-05-11');
/*!40000 ALTER TABLE `parceiro_negocio` ENABLE KEYS */;
UNLOCK TABLES;
